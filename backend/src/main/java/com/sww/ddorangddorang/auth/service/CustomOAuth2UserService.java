...
import com.sww.ddorangddorang.auth.dto.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new CustomOAuth2User(
                Collections.singleton(new SimpleGrantedAuthority(createdUser.getRole().substring(5))),
                attributes,
     ...
     */
    private User getUser(OAuthAttributes attributes, String providerType) {
        User findUser = userRepository.findByProviderTypeAndProviderId(providerType,
     ...
     */
    private User saveUser(OAuthAttributes attributes, String providerType) {
